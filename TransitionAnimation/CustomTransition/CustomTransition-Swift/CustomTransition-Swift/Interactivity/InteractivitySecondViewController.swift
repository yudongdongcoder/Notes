...
class InteractivitySecondViewController: UIViewController {
    lazy var interactiveTransitionRecognizer: UIScreenEdgePanGestureRecognizer = UIScreenEdgePanGestureRecognizer.init(target: self, action: #selector(InteractivitySecondViewController.interactiveTransitionRecognizerAction(_:)))
...
extension InteractivitySecondViewController {
    func setupView() {
        ...
        button.addTarget(self, action: #selector(InteractivitySecondViewController.buttonDidClicked(_:)), for: .touchUpInside)
